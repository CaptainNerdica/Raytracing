...
namespace Raytracing.Objects
{
	public class Plane : SceneObject
	{
		...
		public Vector3 Normal { get => _normal; set => _normal = value.Normalized; }
	...
	public class TiledPlane : Plane
	{
		...
		public Vector3 Basis { get => _basis; set => _basis = Vector3.Reject(value, Normal).Normalized; }
		...
		public override Material MaterialAt(Point point)
		{
			...
			Vector3 planePos = Vector3.Reject(vec, Normal);
			float x = Vector3.Dot(Basis, Vector3.Project(planePos, Basis));
			float y = Vector3.Dot(Vector3.Cross(Basis, Normal), Vector3.Reject(planePos, Basis));
